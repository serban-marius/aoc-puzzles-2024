...
// let gearMatrix = Array.from(Array(140), () => new Array(140))

console.log(gearMatrix[0][0][0])
    ...
    for (; x < lineArray.length;) {
        ...
        if (!isNaN(char)) {
            ...
            if (x > 0) {
                ...
                if (isNaN(char)) {
                    if (char === '.') {
                        // console.log(char + " <--- Not a symbol, is a dot!!");
                    } else {
                        console.log(char + " <--- Symbol!! ---------------------------------");
...
function getFullNumber(y, x) {
    ...
    console.log("getFullnumber: X => " + x + " | Y => " + y + " | length => " + matrix[y].length);
