...
let gearMatrix = Array(140).fill('').map(() => Array(140).fill('').map(() => Array(6)))
            ...
            if (x > 0) {
                ...
                if (isNaN(char)) {
                    if (char === '.') {
                        ...
                        gearMatrix[y][x - 1].push(fullNumber);
            ...
            if (x > 0 && y > 0) {
                ...
                if (isNaN(char)) {
                    if (char === '.') {
                        ...
                        let {fullNumber, positionsAdvanced} = getFullNumber(y, x);
                        gearMatrix[y - 1][x - 1].push(fullNumber);
            ...
            if (y > 0) {
                ...
                if (isNaN(char)) {
                    if (char === '.') {
                        ...
                        let {fullNumber, positionsAdvanced} = getFullNumber(y, x);
                        gearMatrix[y - 1][x].push(fullNumber);
...
gearMatrix.forEach(row => {
    row.forEach(position => {
        let cleanNumbers = position.filter(a => a !== null)
